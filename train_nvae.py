...
def main(args):
    ...
    for epoch in range(init_epoch, args.epochs):
        ...
        # Training.
        train_nelbo, global_step, logits, loss_queue = train(train_queue, model, cnn_optimizer, grad_scalar, global_step, warmup_iters, writer, logging)
        logging.info('train_nelbo %f', train_nelbo)
        writer.add_scalar('train/nelbo', train_nelbo, global_step)
        losses.extend(loss_queue)
